...
public class ConexaoBairroController {
    ...
    @GetMapping("/busca")
    public ResponseEntity<List<ConexaoBairroResponseDTO>> buscaAvancada(@RequestParam("q") String query) {
        List<ConexaoBairroResponseDTO> resultado = conexaoBairroService.buscarAvancado(query);
