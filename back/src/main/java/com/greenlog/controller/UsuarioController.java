...
public class UsuarioController {
    ...
    @GetMapping("/busca")
    public ResponseEntity<List<UsuarioResponseDTO>> buscaAvancada(@RequestParam("q") String query) {
        List<UsuarioResponseDTO> resultado = usuarioService.buscarAvancado(query);
