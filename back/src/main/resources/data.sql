...
MERGE INTO itinerario (id, data, caminhao_id, rota_id, status_itinerario_enum) KEY(id) VALUES
    (1, DATE '2025-03-01', 1, 1, 'PENDENTE'),
    (2, DATE '2025-03-01', 2, 2, 'PENDENTE'),
    (3, DATE '2025-03-02', 3, 3, 'PENDENTE'),
    (4, DATE '2025-03-03', 1, 3, 'PENDENTE');
